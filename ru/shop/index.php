...
<body>
  ...
  <div id="currentItem"><img id='currentImg'><div id="currentISim"></div><div id="currentDes"></div><div id="buyBtn">Купить</div><div id="buyBtn">Заказать</div><div class="fil-close-btn" style="top: 500px;"><div></div><div></div></div></div>
  <div id="container">
    <div id="items">
      <div class="row">
