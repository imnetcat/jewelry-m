...
function set_pages(allItems){
  ...
  $('.item').click( (ev) => {
    ...
    $('#currentImg').click( () => {
      $('body').append('<div id="fullImg"><img src="items/full/'+$('#currentImg').attr('src').split("/")[1]+'"/><div id="floatingCirclesG"><div class="f_circleG" id="frotateG_01"></div><div class="f_circleG" id="frotateG_02"></div><div class="f_circleG" id="frotateG_03"></div><div class="f_circleG" id="frotateG_04"></div><div class="f_circleG" id="frotateG_05"></div><div class="f_circleG" id="frotateG_06"></div><div class="f_circleG" id="frotateG_07"></div><div class="f_circleG" id="frotateG_08"></div></div><div class="fil-close-btn" style="top: 82vh; left: 49%;"><div></div><div></div></div></div>');
